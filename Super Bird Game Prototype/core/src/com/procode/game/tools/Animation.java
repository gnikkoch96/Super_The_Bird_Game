...
public class Animation {
    ...
    public void setAnimation(String animationDir, int imgWidth, int imgHeight, int startingFrame, int endingFrame, float animSecs, boolean loop){
    ...
    public void setLoop(boolean loop){this.isLoop = loop;}; // set the loop
