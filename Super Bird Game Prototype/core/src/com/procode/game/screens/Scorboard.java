...
public class Scorboard implements Screen {
    ...
    public Scorboard(SuperBirdGame g) {
        game = g;
        ...
        Label name = new Label("Robin" + nameSpace + "700",labelStyle);
        name.setAlignment(Align.center);
        Label username = new Label("Kevin" + nameSpace + "600", labelStyle);
        username.setAlignment(Align.center);
        Label password = new Label("Jordan" + nameSpace + "500", labelStyle);
        password.setAlignment(Align.center);
        Label email = new Label("Emilia"+ nameSpace + "500", labelStyle);
